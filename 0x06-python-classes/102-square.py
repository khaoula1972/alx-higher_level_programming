...
class Square:
    ...
    def __ne__(self, other):
        """
        Check if the Values are not equal or not.
        """
        return (self.area() != other.area())

    def __lt__(self, other):
        """
        Check if the self square is strictly smaller than the other.
        """
        return (self.area() < other.area())

    def __le__(self, other):
        """
        Check if the self square is smaller or equal to the other.
        """
        return (self.area() <= other.area())

    def __gt__(self, other):
        """
        Check if the self square is strictly greater than the other.
        """
        return (self.area() > other.area())

    def __ge__(self, other):
        """
        Check if the self square is greater or equal than the other.
        """
        return (self.area() >= other.area())
